...
type ReceiptDetail = Omit<ReceiptListItem, "frontImageUrl"> & {
  rawOcr: string;
  canMutate: boolean;
  images: {
    id: string;
...
function ownerLabel(item: Pick<ReceiptListItem, "ownerUserId">, userId: string) {
...
export function ReceiptAlbum({
  ...
  const syncDraft = useCallback((doc: ReceiptDetail) => {
  ...
  async function handleExportCsv() {
    ...
    try {
      ...
      a.href = url;
      a.download = `receipts_${activeMode}_${stamp}.csv`;
            ...
            <li key={item.id} className="relative">
              ...
              >
                <input
                  ...
                  aria-label={`${item.title || "タイトル未設定"}を選択`}
                />
              </label>
              <button
                type="button"
